...
class Atualizacao:
    def __init__(self):
        ...
        self.win.canvas = Canvas(self.win, height=55, width=1000, bg='#48D1CC')
        self.win.canvas.pack()
        self.win.canvas.place(x=0, y=0)

        self.lbAtualizar = Label(self.win, text="Atualização", bg="#48D1CC", foreground="white",
                                        font=("Georgia", 15, 'bold'))
        self.lbAtualizar.place(x=200, y=15)

        self.lbId = Label(self.win, text="Informe o id da pessoa:", bg="#00FFFF", foreground="Black",
                          font=("Georgia", 10, 'bold'))
        self.lbId.place(x=170, y=70)

        self.txtId = Entry(self.win, font=('Georgia', 10), width=4)
        self.txtId.place(x=344, y=70)
        ...
        self.btAtualizar = Button(self.win, text="Atualizar ", font=('Georgia', 13, 'bold')
                                  , width=12, bg='#48D1CC', fg='white',command=self.Atualizar)
        self.btAtualizar.place(x=280, y=520)

        self.btLimpar = Button(self.win, text="Voltar", font=('Georgia', 13, 'bold')
                               , width=12, bg='#48D1CC', fg='white', command=self.Voltar)
    ...
    def Limpar(self):
        ...
        self.txtId.delete(0, len(self.txtId.get()))
    def Voltar(self):
        self.win.destroy()
